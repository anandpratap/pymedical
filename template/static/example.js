...
$(document).ready(function() {
  ...
  $("#addrow").click(function(){
    $(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-wpr"><textarea id="autocomplete"></textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div></td><td class="batch"><textarea>()</textarea></td><td><textarea class="cost">0.00</textarea></td><td><textarea class="quantity">1</textarea></td><td><span class="price">Rs. 0.00</span></td><td><textarea class="vat">0.00</textarea></td><td><span class="amount">Rs. 0.00</span></td></tr>');
  ...
  $("p").text("The DOM is now loaded and can be manipulated.JS");
